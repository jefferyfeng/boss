	...
	<div class="layui-col-xs12 layui-col-sm6 layui-col-md6">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="hidden" value="${user.id}" name="userId" disabled class="layui-input layui-disabled">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="password" value="" placeholder="请输入新密码" lay-verify="required|newPwd" name="newPwd" class="layui-input pwd">
			</div>
		</div>
		<div class="layui-form-item">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/modules/sysuser/sysUser_pwd_edit.js"></script>
</body>
</html>