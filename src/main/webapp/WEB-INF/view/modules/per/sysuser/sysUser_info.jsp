...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/page/user/userInfo.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/static/page/user/cacheUserInfo.js"></script>
</body>
</html>