...
<form class="layui-form" id="editSysDemoForm" style="width:80%;">
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="demoDate" value="${sysDemo.demoDate}"  lay-verify="demoDate" placeholder="请输入测试时间">
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs12">
        <label class="layui-form-label">测试状态</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="status" value="${sysDemo.status}"  lay-verify="status" placeholder="请输入测试状态">
        </div>
    </div>
