			    ...
			    <ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" id="userInfo">
						...
						<dl class="layui-nav-child">
							<dd>
                                <a href="javascript:;" data-url="${pageContext.request.contextPath}/static/page/user/userInfo.jsp">
                                    <i class="seraph icon-ziliao" data-icon="icon-ziliao"></i><cite>个人资料</cite>
                                </a>
                            </dd>
							<dd>
                                <a href="javascript:;" data-url="${pageContext.request.contextPath}/per/toChangePwd">
